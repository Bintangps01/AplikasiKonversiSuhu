...
Sebuah aplikasi yang dapat digunakan untuk mengubah suhu awal menjadi skala suhu lain yang ditujukan untuk menyelesaikan Tugas PBO ke-2.
...
## Fitur Utama
- Konversi Suhu
- Membatasi Input Agar Hanya Bisa Menggunakan Angka

## Fitur Tambahan (Variasi)
- Skala Suhu Lebih Lengkap
- Radio Button Untuk Arah Konversi
- Konversi Otomatis Jika Terdeteksi Perubahan Nilai Input
## Referensi

 - [Modul PBO2 Tugas 2](https://drive.google.com/file/d/11-22-Gfbu5j0-WwyCsrQ0NIwh10d9IfS/view)
